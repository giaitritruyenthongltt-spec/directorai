/**
 * gen-ui-icons — sinh file .svg đơn sắc vào apps/panel/icons/ui/.
 *
 * LÝ DO: UXP manifest v5 CHẶN `data:` URI trong <img> (icon trắng), và KHÔNG
 * render <svg> nội tuyến / `mask-image`. Nhưng FILE ẢNH CỤC BỘ thì render
 * (bằng chứng: icons/icon23.png). Nên ta xuất .svg ra đĩa, copy vào dist qua
 * CopyWebpackPlugin, rồi <img src="icons/ui/<name>.svg">.
 *
 * Chạy: node tools/gen-ui-icons.mjs  (đã gọi tự động trong prebuild nếu thêm).
 */
