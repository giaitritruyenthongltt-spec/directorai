...
function sidebar(section, pages, currentSlug) {
...
`;
export function renderShell(content, opts) {
...
export function renderIndex(pagesBySection) {
  ...
  return renderShell(
    `<h1>DirectorAI Documentation</h1><p>${escape('AI Editing Copilot for Adobe Premiere Pro.')}</p>${blocks}`,
