/**
 * Icon — hệ icon SVG nội tuyến (thay emoji).
 *
 * LÝ DO: UXP webview của Premiere KHÔNG có đủ font emoji → emoji hiện thành ô
 * vuông "tofu" (□). SVG stroke (kiểu Lucide/Feather, MIT) khắc phục triệt để:
 * sắc nét mọi kích thước, ăn theo `currentColor` nên tự đổi theo theme, nhẹ,
 * không phụ thuộc package ngoài. Dùng 1 nguồn icon cho toàn panel → nhất quán.
 *
 * Cách dùng: <Icon name="film" /> · <Icon name="zap" size={20} />
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  wand: (
    <>
      <path d="m15 4 1 1M9.5 7.5 4 13l-2 7 7-2 5.5-5.5" />
      <path d="m18 11 2-2M19 3v4M21 5h-4" />
    </>
  ),
  list: (
    <>
