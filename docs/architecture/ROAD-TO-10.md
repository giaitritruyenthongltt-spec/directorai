...
| ------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **RG1** | `SequenceEditor.createInsertProjectItemAction` có CHÈN clip live được? giữ trim/speed? | import 1 clip→ProjectItem; insert vào sequence tại t; read-back vị trí/độ-dài; thử kèm in/out + speed | PASS→Phase 1 dựng-trong-Premiere; một phần→tìm action giữ trim/speed; FAIL→giữ file-export làm chính + ghi ADR |
