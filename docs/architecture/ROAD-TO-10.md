...
| ------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **RG1** | `SequenceEditor.createInsertProjectItemAction` có CHÈN clip live được? giữ trim/speed? | import 1 clip→ProjectItem; insert vào sequence tại t; read-back vị trí/độ-dài; thử kèm in/out + speed | 🟢 **1/2 ĐÓNG (probe live 2026-06-10)**: getEditor OK, `createInsertProjectItemAction` arity **5**, `createOverwriteItemAction` arity **4**, vTrack=4 → API CHÈN CÓ THẬT, callable. Còn: tìm chữ-ký 5 tham số + test insert+read-back+remove live |
