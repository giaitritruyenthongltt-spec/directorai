...
| **SAFE-1**  | Tầng an toàn               | checkpoint tự động + preview bắt buộc + chế độ báo-cáo                  | 🟢 preview + apply(disable/rename) + cổng duyệt (18 test); còn dry-run live + trim/move/transition |
